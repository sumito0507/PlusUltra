 ...
 * <br/><br/>If code is orderBy([ÅfnameÅf, Åeage']), sort by age after sort by name.
    ...
    value: function parseNode_(statement) {
      ...
      if (spaceSplitParts.length === 3) {
        ...
        if (parts.length === 2) {
          ...
          // OR,ANDÇ™2Ç¬à»è„Ç†ÇÈèÍçáÇÃëŒèà:èâÇﬂÇÃOR,ANDÇ≈2Ç¬Ç…ãÊêÿÇÈ
          var rightPart = '';
